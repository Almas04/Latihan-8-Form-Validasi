...
<body> 
     ...
     <div class="card-body"> 
      <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
       ...
       <div class="form-group row">
         ...
         <div class="col-sm-10">
          <input type="date" name="tglmsk" class="form-control <?php echo ($error_tglmsk !="" ? "is-invalid" : ""); ?>" id="
          tglmsk" placeholder="Tanggal Masuk" value="<?php echo $tglmsk; ?>"><span class="warning"><?php echo $error_tglmsk; ?></span>
         </div>
       </div>
       ...
       <div class="form-group row">
         ...
         <div class="col-sm-10">
          <input type="text" name="kecamatan" class="form-control <?php echo ($error_kecamatan !="" ? "is-invalid" : ""); ?>" id="
          kecamatan" placeholder="kecamatan" value="<?php echo $kecamatan; ?>"><span class="warning"><?php echo $error_kecamatan; ?></span>
         </div>
       </div>
    ...
    <?php 
    include 'koneksi.php';
    $query = "INSERT INTO siswa SET tgl='$tgl', jp='$jp', tglmsk='$tglmsk', nis='$nis', noujian='$noujian', paud='$paud', tk='$tk', skhun='$skhun', 
    ijazah='$ijazah',hobi='$hobi', citacita='$citacita', nama='$nama', jk='$jk', nisn='$nisn', nik='$nik', tmpl='$tmpl', tgll='$tgll', agama='$agama', 
    berkhus='$berkhus', alamat='$alamat',rt='$rt', rw='$rw', dusun='$dusun', desa='$desa', kecamatan='$kecamatan', kodepos='$kodepos', tmptinggal='$tmptinggal',transport='$transport', nohp='$nohp', notelp='$notelp', email='$email', kps='$kps', nokps='$nokps', kwn='$kwn', negara='$negara'";

    if (mysqli_query($koneksi, $query)) {
        echo "<script>alert('Data berhasil di simpan');window.location='formpendaftaransiswa.php'</script>";
    }
    ?>
